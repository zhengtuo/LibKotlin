...
/**
 * @Author: Drelovey
 * @CreateDate: 2020/3/4 15:52
 */
public class BindingCommand<T> {
    private BindingAction execute;
    private BindingGenericity<T> consumer;
     ...
     */
    public BindingCommand(BindingGenericity<T> execute) {
     ...
     * @param canExecute0 true则执行,反之不执行
     */
    public BindingCommand(BindingGenericity<T> execute, BindingFunction<Boolean> canExecute0) {
        this.consumer = execute;
        this.canExecute0 = canExecute0;
    }
